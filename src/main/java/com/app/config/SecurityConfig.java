...
public class SecurityConfig extends WebSecurityConfigurerAdapter
{
	...
	public void configure(WebSecurity web) throws Exception
	{
		...
		web.ignoring().antMatchers("/", "/resources/**", "/static/**", "/public/**", "/webui/**", "/h2-console/**",
			...
			"/v2/api-docs/**", "/*.html", "/**/*.html", "/**/*.css", "/**/*.js", "/**/*.png", "/**/*.jpg", "/**/*.gif",
	...
	protected void configure(HttpSecurity http) throws Exception
	{
		http.authorizeRequests().antMatchers(
			"/user").permitAll().and().exceptionHandling().and().anonymous().and()
		...
		// custom JSON based authentication by POST of {"username":"<name>","password":"<password>"} which sets the
	...
	/*
	 * If You want to store encoded password in your databases and authenticate user based on encoded password then
	 * uncomment the below method and provde an encoder
	 *
